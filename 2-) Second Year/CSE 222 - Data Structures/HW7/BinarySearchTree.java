...
/**
 * A class that acts like a binary search tree.
 */
public class BinarySearchTree<E> extends Tree<E> implements SearchTree<E>
{	
	...
	*/
	...
	/**
	 * @return false if the BinarySearchTree is a RedBlackTree
	 * @throws NotRedBlackTreeException if the BinarySearchTree is not a RedBlackTree
	 */
	protected boolean isRed() throws NotRedBlackTreeException
	{
		throw new NotRedBlackTreeException("The tree is not a RedBlackTree. It is a regular BinarySearchTree.");
	}
